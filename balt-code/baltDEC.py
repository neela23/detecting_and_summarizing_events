...
G = nx.read_weighted_edgelist('/scratch2/navudai/baltimore/graph/graph301.weighted.edgelist') 
print len(G)
...
for i in range(301, 384):#range(len(tweetFiles)):
	decreaseEdgeWeights()
	...
	fileName = "/scratch2/navudai/baltimore/dynamicECall/ecentrality"+`i+1`+".txt"
